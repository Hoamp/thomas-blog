        ...
        <div class="container py-5">
            <div class="row my-3 mb-4">
                <div class="col-md-8">
                    ...
                    <hr class="my-3 mr-5">
                    <form action="" method="GET" class="card-search card-sm mt-4 mr-5">
                        <div class="card-body row no-gutters align-items-center" style="padding: 0">
                            <div class="col">
                                <input class="form-control form-control-lg form-control-borderless" name="q" type="search" placeholder="Mau Cari Apa Hari Ini?">
                            </div>
                        </div>
                    </form>
                </div>
